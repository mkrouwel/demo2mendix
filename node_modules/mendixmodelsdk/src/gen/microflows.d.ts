...
export declare namespace microflows {
    ...
    class CallExternalAction extends MicroflowAction {
         ...
         * @ignore
         */
        get consumedODataService(): rest.IConsumedODataService;
        set consumedODataService(newValue: rest.IConsumedODataService);
        get consumedODataServiceQualifiedName(): string;
        get name(): string;
